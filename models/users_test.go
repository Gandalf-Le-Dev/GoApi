...
var (
	userDBTypes = map[string]string{`UserID`: `integer`, `Username`: `character varying`, `Email`: `character varying`, `PasswordHash`: `character varying`, `CreatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
