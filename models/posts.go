...
var PostWhere = struct {
	...
	CategoryID: whereHelpernull_Int{field: "\"posts\".\"category_id\""},
...
func (r *postR) GetCategory() *Category {
	if r == nil {
		return nil
	}
	return r.Category
...
var (
	postAllColumns            = []string{"post_id", "user_id", "category_id", "title", "content", "created_at", "updated_at"}
	postColumnsWithoutDefault = []string{"user_id", "title", "content"}
	postColumnsWithDefault    = []string{"post_id", "category_id", "created_at", "updated_at"}
...
func (o *Post) Category(mods ...qm.QueryMod) categoryQuery {
...
func (postL) LoadCategory(ctx context.Context, e boil.ContextExecutor, singular bool, maybePost interface{}, mods queries.Applicator) error {
	var slice []*Post
	var object *Post
...
// SetCategory of the post to the related item.
// Sets o.R.Category to related.
// Adds o to related.R.Posts.
func (o *Post) SetCategory(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Category) error {
	var err error
	if insert {
	...
	values := []interface{}{related.CategoryID, o.PostID}
...
func (o *Post) RemoveCategory(ctx context.Context, exec boil.ContextExecutor, related *Category) error {
	var err error
